...
const KEYWORDS = {
	...
	'muju-hyangnosan-recreation-forest': { keywords: ['무주 향로산자연휴양림', '향로산자연휴양림'], match: '향로산' },
	'incheon-metropolitan-museum': { keywords: ['인천광역시립박물관', '인천시립박물관'], match: '시립박물관' },
	'wolgot-fishing-port': { keywords: ['월곶포구'], match: '월곶포구' },
	'wondong-station-plum-village': { keywords: ['원동역', '순매원'], match: '원동' },
	'jirisan-jungsanri-course': { keywords: ['지리산 중산리', '중산리탐방지원센터'], match: '중산리' },
	'descendants-of-the-sun-filming-site': { keywords: ['삼탄아트마인'], match: '삼탄아트마인' },
	'yunjerim-forest-garden': { keywords: ['윤제림'], match: '윤제림' },
	...
	'yangpyeong-cheongchun-museum': { keywords: ['청춘뮤지엄'], match: '청춘' },
	'suseongdong-valley': { keywords: ['수성동계곡', '인왕산 수성동'], match: '수성동' },
	...
	'namhae-sangsang-sheep-farm': { keywords: ['상상양떼목장', '남해 상상양떼목장'], match: '양떼목장' },
	'hongje-waterfall': { keywords: ['홍제폭포'], match: '홍제폭포' },
};
