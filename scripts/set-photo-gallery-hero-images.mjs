...
const KEYWORDS = {
	...
	'ochang-rest-area': { keywords: ['오창휴게소'], match: '오창휴게소' },
	'muju-hyangnosan-recreation-forest': { keywords: ['향로산자연휴양림', '무주 향로산자연휴양림', '향로산 자연휴양림'], match: '향로산' },
	'incheon-metropolitan-museum': { keywords: ['인천시립박물관', '인천광역시립박물관'], match: '박물관' },
	'wolgot-fishing-port': { keywords: ['월곶포구', '시흥 월곶포구'], match: '월곶' },
	'wondong-station-plum-village': { keywords: ['원동역', '순매원'], match: '원동' },
	'jirisan-jungsanri-course': { keywords: ['지리산 천왕봉', '중산리탐방지원센터', '지리산 중산리'], match: '지리산' },
	'descendants-of-the-sun-filming-site': { keywords: ['삼탄아트마인'], match: '삼탄아트마인' },
	'yunjerim-forest-garden': { keywords: ['윤제림', '보성 윤제림'], match: '윤제림' },
	'jwagusan-recreation-forest': { keywords: ['좌구산자연휴양림', '좌구산천문대'], match: '좌구산' },
	'chunhyang-rest-area': { keywords: ['춘향휴게소'], match: '춘향휴게소' },
	'hwanggeumsan-elephant-rock': { keywords: ['황금산', '황금산 코끼리바위'], match: '황금산' },
	'yangpyeong-cheongchun-museum': { keywords: ['추억의 청춘뮤지엄', '청춘뮤지엄'], match: '청춘' },
	'suseongdong-valley': { keywords: ['인왕산 수성동 계곡', '수성동계곡', '인왕산 수성동'], match: '수성동' },
	'hanam-union-park': { keywords: ['하남유니온파크', '유니온타워'], match: '유니온' },
	'yeongcheon-rest-area': { keywords: ['영천휴게소'], match: '영천휴게소' },
	'seocheon-seafood-market': { keywords: ['서천수산물특화시장'], match: '수산물특화시장' },
	'hamyang-rest-area': { keywords: ['함양휴게소'], match: '함양휴게소' },
	'namhae-sangsang-sheep-farm': { keywords: ['남해 상상양떼목장 편백숲', '상상양떼목장', '남해 상상양떼목장'], match: '양떼목장' },
	'hongje-waterfall': { keywords: ['홍제폭포', '홍제천 인공폭포'], match: '홍제' },
	'gachang-aufonddubois': { keywords: ['오퐁드부아'], match: '오퐁드부아' },
	'jeongseojin-jungang-market': { keywords: ['정서진중앙시장', '가정중앙시장'], match: '정서진' },
	'jangyeongsil-science-museum': { keywords: ['장영실과학관', '아산장영실과학관'], match: '장영실' },
	'iksan-dinosaur-theme-park': { keywords: ['익산공룡테마파크', '익산 공룡테마공원'], match: '공룡' },
	'mangwolsa-temple': { keywords: ['망월사', '도봉산 망월사'], match: '망월사' },
	'gijang-sowonsa-temple': { keywords: ['소원사', '기장 소원사'], match: '소원사' },
	'namhae-jeokjeong-ondo-cafe': { keywords: ['적정온도', '남해 적정온도'], match: '적정온도' },
	'anseong-matchum-astronomical-science-museum': { keywords: ['안성맞춤천문과학관'], match: '천문과학관' },
	'yeongcheon-unjusan-recreation-forest': { keywords: ['운주산승마자연휴양림', '운주산자연휴양림'], match: '운주산' },
	'kkulbeol-nara-theme-park': { keywords: ['꿀벌나라테마공원'], match: '꿀벌나라' },
	'ulju-rest-area': { keywords: ['울주휴게소'], match: '울주휴게소' },
	'seogwipo-arts-center': { keywords: ['서귀포예술의전당'], match: '예술의전당' },
	'jeju-seonunjeongsa-temple': { keywords: ['선운정사'], match: '선운정사' },
	'namwon-baekdudaegan-ecology-center': { keywords: ['백두대간생태교육장'], match: '생태교육장' },
	'busan-metropolitan-museum': { keywords: ['부산박물관', '부산시립박물관'], match: '부산박물관' },
	'bangujeong-pavilion': { keywords: ['반구정'], match: '반구정' },
	'amazon-aquapark-wanju': { keywords: ['아마존아쿠아파크', '아마존 아쿠아파크 완주'], match: '아마존' },
	'gukchaebosang-memorial-park': { keywords: ['국채보상운동기념공원', '국채보상공원'], match: '국채보상' },
	'chilgok-dogae-hot-spring': { keywords: ['도개온천', '칠곡 도개온천'], match: '도개온천' },
	'war-memorial-library': { keywords: ['전쟁기념관'], match: '전쟁기념관' },
};
