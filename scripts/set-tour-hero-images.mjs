...
const KEYWORDS = {
	...
	'gachang-aufonddubois': { keywords: ['오퐁드부아'], areaCode: AREA.대구, match: '오퐁드부아' },
	'jeongseojin-jungang-market': { keywords: ['정서진중앙시장', '가정중앙시장'], areaCode: AREA.인천, match: '정서진' },
	'jangyeongsil-science-museum': { keywords: ['장영실과학관', '아산장영실과학관'], areaCode: AREA.충남, match: '장영실' },
	'iksan-dinosaur-theme-park': { keywords: ['익산공룡테마파크', '익산 공룡테마공원'], areaCode: AREA.전북, match: '공룡' },
	'mangwolsa-temple': { keywords: ['망월사', '도봉산 망월사'], areaCode: AREA.경기, match: '망월사' },
	'gijang-sowonsa-temple': { keywords: ['소원사', '기장 소원사'], areaCode: AREA.부산, match: '소원사' },
	'namhae-jeokjeong-ondo-cafe': { keywords: ['적정온도', '남해 적정온도'], areaCode: AREA.경남, match: '적정온도' },
	'anseong-matchum-astronomical-science-museum': { keywords: ['안성맞춤천문과학관'], areaCode: AREA.경기, match: '천문과학관' },
	'yeongcheon-unjusan-recreation-forest': { keywords: ['운주산승마자연휴양림', '운주산자연휴양림'], areaCode: AREA.경북, match: '운주산' },
	'kkulbeol-nara-theme-park': { keywords: ['꿀벌나라테마공원'], areaCode: AREA.경북, match: '꿀벌나라' },
	'ulju-rest-area': { keywords: ['울주휴게소'], match: '울주휴게소' },
	'seogwipo-arts-center': { keywords: ['서귀포예술의전당'], areaCode: AREA.제주, match: '예술의전당' },
	'jeju-seonunjeongsa-temple': { keywords: ['선운정사'], areaCode: AREA.제주, match: '선운정사' },
	'namwon-baekdudaegan-ecology-center': { keywords: ['백두대간생태교육장'], areaCode: AREA.전북, match: '생태교육장' },
	'busan-metropolitan-museum': { keywords: ['부산박물관', '부산시립박물관'], areaCode: AREA.부산, match: '부산박물관' },
	'bangujeong-pavilion': { keywords: ['반구정'], areaCode: AREA.경기, match: '반구정' },
	'amazon-aquapark-wanju': { keywords: ['아마존아쿠아파크', '아마존 아쿠아파크 완주'], areaCode: AREA.전북, match: '아마존' },
	'gukchaebosang-memorial-park': { keywords: ['국채보상운동기념공원', '국채보상공원'], areaCode: AREA.대구, match: '국채보상' },
	'chilgok-dogae-hot-spring': { keywords: ['도개온천', '칠곡 도개온천'], areaCode: AREA.경북, match: '도개온천' },
	'war-memorial-library': { keywords: ['전쟁기념관'], areaCode: AREA.서울, match: '전쟁기념관' },
