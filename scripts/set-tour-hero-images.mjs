...
const KEYWORDS = {
	...
	'muju-hyangnosan-recreation-forest': { keywords: ['무주 향로산자연휴양림', '향로산자연휴양림'], areaCode: AREA.전북, match: '향로산' },
	'incheon-metropolitan-museum': { keywords: ['인천광역시립박물관', '인천시립박물관'], areaCode: AREA.인천, match: '시립박물관' },
	'wolgot-fishing-port': { keywords: ['월곶포구'], areaCode: AREA.경기, match: '월곶포구' },
	'wondong-station-plum-village': { keywords: ['원동역', '순매원'], areaCode: AREA.경남, match: '원동' },
	'jirisan-jungsanri-course': { keywords: ['지리산 중산리', '중산리탐방지원센터'], areaCode: AREA.경남, match: '중산리' },
	'descendants-of-the-sun-filming-site': { keywords: ['삼탄아트마인'], areaCode: AREA.강원, match: '삼탄아트마인' },
	'yunjerim-forest-garden': { keywords: ['윤제림'], areaCode: AREA.전남, match: '윤제림' },
	'jwagusan-recreation-forest': { keywords: ['좌구산자연휴양림', '좌구산천문대'], areaCode: AREA.충북, match: '좌구산' },
	'chunhyang-rest-area': { keywords: ['춘향휴게소'], areaCode: AREA.전북, match: '춘향휴게소' },
	'hwanggeumsan-elephant-rock': { keywords: ['황금산', '황금산 코끼리바위'], areaCode: AREA.충남, match: '황금산' },
	'yangpyeong-cheongchun-museum': { keywords: ['청춘뮤지엄'], areaCode: AREA.경기, match: '청춘' },
	'suseongdong-valley': { keywords: ['수성동계곡', '인왕산 수성동'], areaCode: AREA.서울, match: '수성동' },
	'hanam-union-park': { keywords: ['하남유니온파크', '유니온타워'], areaCode: AREA.경기, match: '유니온' },
	'yeongcheon-rest-area': { keywords: ['영천휴게소'], areaCode: AREA.경북, match: '영천휴게소' },
	'seocheon-seafood-market': { keywords: ['서천수산물특화시장'], areaCode: AREA.충남, match: '수산물특화시장' },
	'hamyang-rest-area': { keywords: ['함양휴게소'], areaCode: AREA.경남, match: '함양휴게소' },
	'namhae-sangsang-sheep-farm': { keywords: ['상상양떼목장', '남해 상상양떼목장'], areaCode: AREA.경남, match: '양떼목장' },
	'hongje-waterfall': { keywords: ['홍제폭포'], areaCode: AREA.서울, match: '홍제폭포' },
