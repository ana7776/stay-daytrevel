...
const QUERIES = {
	...
	'gachang-aufonddubois': 'hanok cafe forest window mountain korea',
	'jeongseojin-jungang-market': 'traditional market korea seafood stalls',
	'jangyeongsil-science-museum': 'science museum exhibition hall korea',
	'iksan-dinosaur-theme-park': 'dinosaur theme park statues outdoor korea',
	'mangwolsa-temple': 'buddhist temple mountain ridge korea',
	'gijang-sowonsa-temple': 'golden buddha statue temple korea',
	'namhae-jeokjeong-ondo-cafe': 'countryside cafe nature relaxing korea',
	'anseong-matchum-astronomical-science-museum': 'observatory telescope night sky korea',
	'yeongcheon-unjusan-recreation-forest': 'forest horseback riding trail korea',
	'kkulbeol-nara-theme-park': 'riverside park honeybee exhibit korea',
	'ulju-rest-area': 'highway rest area service korea',
	'seogwipo-arts-center': 'concert hall building jeju architecture',
	'jeju-seonunjeongsa-temple': 'small buddhist temple trail jeju coast',
	'namwon-baekdudaegan-ecology-center': 'ecology education center mountain korea',
	'busan-metropolitan-museum': 'city history museum exhibition hall korea',
	'bangujeong-pavilion': 'traditional korean pavilion riverside korea',
	'amazon-aquapark-wanju': 'water park slides pool summer korea',
	'gukchaebosang-memorial-park': 'city park downtown greenery korea',
	'chilgok-dogae-hot-spring': 'hot spring bath countryside korea',
	'war-memorial-library': 'library reading room city skyline view',
